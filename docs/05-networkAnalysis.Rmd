...
단어는 문장에 함께 사용된 단어가 무엇인지에 따라 다른 의미를 지니게 됩니다. 단어 빈도를 분석하면 어떤 단어가 중요한지는 알 수 있지만, 단어가 어떤 맥락에서 사용되었는지는 알 수 없습니다. 텍스트의 맥락을 이해하려면 단어들의 관계를 살펴봐야 합니다. 이번 장에서는 단어의 관계를 분석하는 방법을 알아보겠습니다.


## 5.1 동시 출현 단어 분석 - Co-occurrence analysis


'손-장갑', '양말-신발'처럼 자주 함께 사용되는 단어가 있습니다. 이런 단어 간의 관계를 살펴보는 분석 방법을 **동시 출현 단어 분석(Co-occurrence analysis)** 이라고 합니다. 동시 출현 단어를 파악해 텍스트에서 어떤 단어가 함께 사용됐는지 살펴보고 네트워크 그래프로 시각화하는 방법을 알아보겠습니다.
